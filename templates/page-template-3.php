...
<div id="content" class="page">
	...
	<div class="row">
		<div class="sidebar small-3 columns">		  	
		  	<section>
			  	<h3>Courses</h3>
			  	<p>Introduction to Public Speaking,  SPCOM 1 - Spring 2013</p>
		  	</section>
		...
		<article>
			<div class="small-6 columns">
				...
				<div class="subpage-banner">
					<img src="../_assets/img/faculty/faculty-banner-example.jpg" alt="Sub Page Banner"/>
					<h1>Jasmin Sun</h1>
				</div>
			
	        	<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc facilisis est vitae ipsum tempor lacinia. Proin eget magna metus. Nam in eleifend dolor, sed venenatis leo. Ut sit amet gravida nisl. Phasellus ultrices quis leo sit amet dignissim.</p>
